...
START_TEST(s21_calc_complements_OK10) {
#line 333
...
START_TEST(s21_calc_complements_OK70) {
#line 346
  matrix_t A = {0}, B = {0}, C = {0};
...
START_TEST(s21_calc_complements_OK_2) {
#line 428
  const int size = 3;
  matrix_t m = {0};
...
START_TEST(s21_calc_complements_OK_3) {
#line 460
  matrix_t a = {0};
  matrix_t b = {0};
  s21_create_matrix(1, 2, &a);
...
int main(void) {
  ...
  tcase_add_test(tc1_8, s21_calc_complements_OK10);
  tcase_add_test(tc1_8, s21_calc_complements_OK70);
  ...
  tcase_add_test(tc1_8, s21_calc_complements_OK_2);
  tcase_add_test(tc1_8, s21_calc_complements_OK_3);
